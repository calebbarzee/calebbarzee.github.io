...
export default function AnimatePi({PI}) {
	...
	useEffect(() => {
	  ...
	  return (
		<div className="flex flex-col gap-4 p-6 md:grid md:grid-cols-5 md:grid-rows-5 md:gap-4 min-h-3 items-center justify-between">
		  ...
		  <div className="border-2 border-slate-300 p-4 rounded-md md:row-start-2 md:col-span-5">
