...
export default function Home() {
   ...
   <div className="grid gap-y-12 grid-cols-7">
      ...
      <div className="col-start-3 col-end-7">
         ...
         <button className="col-span-1 col-start-4 place-self-center w-44 h-10 bg-white shadow-md rounded-lg text-center "><Link to="/development" className="border-b-2 transition-colors duration-300 transform hover:border-blue-500">Additional Projects</Link></button>
      <div className="col-start-4 col-end-5 border-t border-blue-gray-50 py-1"></div>
